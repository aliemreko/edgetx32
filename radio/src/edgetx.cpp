...
{
#if defined(PCBESP32S3)
  return;
#elif !defined(SIMU) && !defined(BOOT)
...
// ESP-IDF owns app_main(); this is invoked from platforms/esp32 bridge.
...
#if !defined(SIMU) && !defined(PCBESP32S3)
